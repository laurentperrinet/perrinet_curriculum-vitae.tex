...
%\begin{resume}
\indent 51 ans, né le 23 Février 1973 à Talence (Gironde, France).  %\\
...
\item	$57$ publications dans des revues avec comité de lecture et $3$ en préparation ou en révision, $16$ en premier auteur, $18$ en dernier auteur, avec un total de $3845$ citations, indice h$=29$ et  indice i10$=57$\footnote{Au 28 Novembre 2024, cf.~\url{https://scholar.google.com/citations?user=TVyUV38AAAAJ&hl=fr}},
\item	$142$ publications dans des actes de congrès avec comité de lecture,
\item	$4$ livres et $6$ chapitres de livres,
\item	$69$ conférences invitées avec présentations orales
ou affichées (dont $19$ dans des congrès internationaux),
\item \href{https://www.theses.fr/074493701}{Thèses de doctorat}:
\begin{itemize}
	\item $5$ finalisées en encadrement principal~\textcite{Khoei2014thesis,Boutin2020thesis,Franciosini2021thesis,Ladret2024thesis,Grimaldi2024thesis},
	\item $4$ co-dirigées finalisées  (~\citep{Kremkow2009thesis,Damasse2018thesis,MansourPour2019thesis,Gruel2023thesis}),
	\item $4$ en cours en encadrement principal (Jean-Nicolas Jérémie, Kevin Mairot, Alexandre Lainé, Matthis Dallain), 
	\item $3$ co-dirigées en cours (Agathe Chopin, Charlotte Roy),
	\item rapporteur de $16$ thèses,
\end{itemize} %
