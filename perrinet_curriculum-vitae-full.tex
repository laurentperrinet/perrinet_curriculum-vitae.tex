...
\newcommand{\Bio}{Laurent Perrinet est un chercheur en neuroscience 
spécialisé dans l'exploration de modèles théoriques des mécanismes de la 
perception visuelle. Il est directeur de recherche CNRS à l'Institut de 
Neurosciences de la Timone à Marseille. Son axe de recherche vise à 
comprendre comment les différents fragments de l'information visuelle sont 
unifiés dans une perception cohérente, malgré les incertitudes intrinsèques 
à la structure de l'information visuelle. Ces travaux visent à construire 
des algorithmes bio-inspirés permettant des gains en performance tout en 
réduisant leur consommation énergétique.}
%%%%%%%%%%%%%%%%%%
%BIBLIOGRAPHY
%%%%%%%%%%%%%%%%%%
...
\begin{itemize}
    ...
    \item \textbf{Responsabilités ou activités collectives au CNRS} : Membre de la commission interdisciplinaire \og Modélisation mathématique, informatique et physique pour les sciences du vivant \fg{} (CID51) lors du dernier mandat.
