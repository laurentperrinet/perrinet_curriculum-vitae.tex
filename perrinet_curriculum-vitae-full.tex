...
\begin{itemize}
	...
	\item $3$ en cours (Jean-Nicolas Jérémie, Kevin Mairot, Alexandre Lainé, Matthis Dallain), 
	\item $3$ co-dirigées en cours (Agathe Chopin, Charlotte Roy),
	\item $5$ co-dirigées finalisées  (Hilde Teigen, Amélie Gruel, Kiana Mansour Pour, JB Damasse, Jens Kremkow),
