...
\addbibresource{LaurentPerrinet_Presentations.bib}
...
%\end{tabular}
\vskip 1cm
\includegraphics[width=1.\textwidth]{troislogos.png}
\vskip 1cm
\begin{tabular}[t]{|c|}
\hline
\Team \\\hline
...
%\begin{resume}
\indent 46 ans, né le 23 Février 1973 à Talence (Gironde, France).  %\\
...
Mon objectif de recherche est d'étudier l'hypothèse selon laquelle on peut comprendre les liens entre la structure neurale et la fonction des systèmes sensoriels comme l'optimisation de leur adaptation aux statistiques des scènes naturelles par des processus de type prédictif.
...
\item  	46 publications dans les revues avec comité de lecture (dont 4 en révision, 16 en premier auteur, 12 en dernier auteur), avec 2313 citations, indice h$=21$ et  indice i10$=38$\footnote{Au 7 janvier 2020, cf.~\url{https://scholar.google.com/citations?user=TVyUV38AAAAJ&hl=fr}},
\item	102 publications dans des actes de congrès avec comité de lecture,
\item	3 livres et 5 chapitres de livres,
\item	44 conférences invitées (dont 19 dans des congrès internationaux),
\item	4 thèses dirigées (Hugo Ladret, Angelo Franciosini, Victor Boutin, Mina Khoei), 
\item	4 Post-docs dirigés (Wahiba Taouali, Nicole Voges, 2 à venir),
\item	3 thèses co-dirigées (Mansour Pour, JB Damasse, J. Kremkow),
\item	1 contrat en PI local ($150 k$\euro{}), 1 AAP ($10 k$\euro{}), 3 bourses de thèse obtenues,
\item	12 contrats en collaborateur (dont 7 ANRs).
...
\begin{itemize}
	...
	\item \href{https://laurentperrinet.github.io/authors/hugo-ladret/}{Hugo Ladret} ``A multiscale cortical model to account for orientation selectivity in natural-like stimulations''  (direction, bourse AMU, co-direction avec Christian Casanova, en cotutelle avec l'Université de Montréal, 2019 / 2022)
\end{itemize}
...
Précédemment, j'ai eu l'occasion d'encadrer des étudiants en direction de thèse, en post-doctorat ou en co-direction de thèse : %, notamment sur l'ANR \href{https://laurentperrinet.github.io/project/anr-rem/}{REM} et le contrat \href{https://laurentperrinet.github.io/project/pace-itn/}{PACE-ITN}: % FACETS-ITN:
\begin{itemize}
...
Je participe ou initie de nombreuses rencontres avec le grand public (cf. \url{https://laurentperrinet.github.io/project/tout-public/}) et en particulier pour l'année 2019:
...
\begin{itemize}
	...
	\item Article de dissemination sur le \href{https://laurentperrinet.github.io/publication/perrinet-19-temps/}{temps dans la perception} dans ``The conversation'' (4600 lectures au 7 janvier 2020). 
	...
	\item Article de dissemination sur les \href{https://theconversation.com/illusions-et-hallucinations-visuelles-une-porte-sur-la-perception-117389}{illusions visuelles} dans ``The conversation'' (7000 lectures au 7 janvier 2020). 
...
\begin{itemize}
 \item \href{https://laurentperrinet.github.io/project/anr-horizontal-v1/}{ANR Horizontal-V1} (2017--2021): ``Connectivité Horizontale et Prédiction de Cohérences dans l’Intégration de Contour'' avec Yves Fregnac et Frédéric Chavane,  
...
\begin{itemize}
	...
	\item Contrats Doctoraux d’Aix-Marseille Université de 2019 (PhD position, 2019--2022).
	...
	\item  \href{https://laurentperrinet.github.io/project/aprovis3D/}{aprovis3D}: ``Aprovis3D: Event-Based Artificial Inteligence'' (2019--2023, coordination globale du projet par Jean Martinet, université de Nice).
...
\begin{itemize}
	...
	\item \href{https://laurentperrinet.github.io/project/anr-rem/}{ANR REM} : Renforcement et mouvements oculaires (2013--2016) avec Anna Montagnini,
	\item \href{https://laurentperrinet.github.io/project/anr-speed/}{ANR SPEED}: Traitement de la vitesse dans les scènes visuelles naturelles (2013--2016)  avec Guillaume Masson,
	\item \href{https://laurentperrinet.github.io/project/anr-trajectory/}{ANR TRAJECTORY} (2016--2019) avec Frédéric Chavane,
	...
	\item \href{https://laurentperrinet.github.io/project/anr-rem/}{CODDE}: understanding brain and behaviour (2008--2012) avec Guillaume Masson,
	\item \href{https://laurentperrinet.github.io/project/anr-rem/}{FACETS-ITN}: From Neuroscience to neuro-inspired computing (2010--2013) avec Guillaume Masson,
	\item \href{https://laurentperrinet.github.io/project/anr-rem/}{FACETS}: Fast Analog Computing with Emergent Transient States (2006--2010) avec Guillaume Masson.
\end{itemize}
...
D'autre part, je participe occasionellement au développement de différentes entreprise de type ``start-up'' dans le cadre d'une autorisation de cumul:
