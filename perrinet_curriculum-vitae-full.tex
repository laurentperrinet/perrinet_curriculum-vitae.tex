...
% vim: set fenc=utf-8
%
% sources: https://www.idref.fr/074493701#
% 
...
\newcommand{\BioSketch}{Laurent Perrinet est chercheur en neurosciences computationnelles au CNRS, directeur de recherche à l'Institut de Neurosciences de la Timone à Marseille. Il s'intéresse à une question fondamentale~: comment notre cerveau parvient-il à construire une image cohérente du monde à partir d'informations visuelles fragmentées et incertaines ? Sur le plan expérimental, il développe des protocoles associant stimulations paramétrables et enregistrements neurophysiologiques pour caractériser les mécanismes de traitement prédictif dans le cortex visuel primaire, notamment le rôle des connexions récurrentes dans la robustesse au bruit sensoriel~\citep{Ladret23}. Sur le plan théorique, il formalise la représentation de l'information visuelle sous forme de motifs spatio-temporels d'impulsions neuronales, une approche fondée sur la notion de polychronie et dont les premières applications neuromorphiques ont démontré des gains énergétiques de plusieurs centaines de fois par rapport aux méthodes analogiques classiques~\citep{Grimaldi23BC}. Ces travaux nourrissent la conception d'algorithmes bio-inspirés à haute efficacité énergétique, applicables à des systèmes embarqués comme les robots aériens ou les caméras événementielles.}
%%%%%%%%%%%%%%%%%%
%BIBLIOGRAPHY
%%%%%%%%%%%%%%%%%%
...
\addbibresource{LaurentPerrinet_publications.bib}
\addbibresource{LaurentPerrinet_talks.bib}
...
%\end{tabular}
\vskip 1cm
\includegraphics[width=1.\textwidth]{logotypes/troislogos.png}
\vskip 1cm
\begin{tabular}[t]{|c|}
\hline
\Team \\\hline
...
Mes travaux de thèse dirigés par Simon Thorpe et Manuel Samuelides ont permis d'explorer dans un cadre mathématique de nouveaux paradigmes de codage neural impulsionnel pour des images statiques~\citep{Perrinet03ieee}, et en particulier comment ceux-ci peuvent être appris par des règles hebbiennes parcimonieuses~\citep{Perrinet10shl}. Ces travaux ont été étendus en collaboration avec Guillaume Masson à des modèles d'inférence statistique appliqués aux mouvements des yeux et à la boucle perception--action~\citep{Simoncini12}. Un cadre théorique précis a ensuite été développé en collaboration avec Karl Friston pour intégrer les délais temporels dans les modèles prédictifs~\citep{PerrinetAdamsFriston14}.

Plus récemment, j'ai étendu ces modèles au traitement dynamique de scènes visuelles en mouvement~\citep{KhoeiMassonPerrinet17}, puis à des architectures hiérarchiques bio-inspirées~\citep{BoutinFranciosiniChavaneRuffierPerrinet20,Franciosini21}. Ces travaux ont notamment permis de revisiter  en collaboration avec Frédéric Chavane la structure de la connectivité horizontale dans le cortex visuel primaire~\citep{Chavane22}. Nous avons par ailleurs mis en évidence le rôle de la précision sensorielle dans le traitement de l'information corticale~\citep{Ladret23}, ouvrant la voie à une représentation parcimonieuse plus efficace des images naturelles~\citep{Ladret24sparse}.

Ces avancées nous ont permis de concevoir de nouveaux algorithmes neuromorphiques de type réseaux de neurones impulsionnels (SNN), capables d'une reconnaissance robuste et ultra-rapide fondée sur la détection de motifs spatio-temporels de spikes~\citep{Grimaldi24}. En parallèle, l'intégration d'une rétinotopie fovéale dans des architectures de vision bio-inspirées améliore significativement la localisation et la catégorisation d'objets dans des conditions écologiques~\citep{Jeremie25}, y compris pour des tâches de recherche visuelle active~\citep{Jeremie25thesis}. Enfin, des collaborations récentes ont étendu le cadre du codage prédictif à la prévision de séries temporelles~\citep{Gunasekaran25} et à la modélisation de textures dynamiques naturelles~\citep{Meso25}, illustrant la portée transversale de ces approches.
...
\begin{itemize}
	\item $3$ en cours en encadrement principal (Alexandre Lainé, Matthis Dallain, Kevin Mairot),
	\item $2$ en cours co-dirigées (Agathe Choplin, Charlotte Roy),
	\item $6$ finalisées en encadrement principal~\citep{Khoei14thesis,Boutin20thesis,Franciosini21thesis,Ladret24thesis,Grimaldi24thesis,Jeremie25thesis},
	\item $4$ co-dirigées finalisées~\citep{Kremkow09thesis,Damasse18thesis,MansourPour19thesis,Gruel23thesis},
	\item Rapporteur de $18$ thèses, Président du jury pour $4$ thèses, Examinateur pour $13$ thèses.
\end{itemize} %
\item $5$ Post-docs dirigés (Wahiba Taouali, Nicole Voges, Alberto Vergani, Adrien Fois, Thomas Kronland-Martinet),
\item $1$ contrat ANR en PI local ($150$\,k€, contrat total $435$\,k€), 1 AAP ($100$\,k€), $3$ bourses de thèse obtenues,
\item Participation à $20$ contrats en collaborateur (dont $12$ ANRs).

\end{itemize} %

\subsection*{Mots clés}
Perception, vision, détection du mouvement. Calcul parallèle événementiel, émergence dans les systèmes complexes, codage neural, réseaux de neurones impulsionnels, représentations parcimonieuses. Inférence bayésienne, minimisation de l'énergie libre, statistiques des scènes naturelles.
...
\begin{itemize}
	\item \href{https://laurentperrinet.github.io/author/jean-nicolas-jeremie/}{Jean-Nicolas Jérémie} ``Foveal Retinotopy and Dual Pathways: A Computational Model for Active Visual Search''~\textcite{Jeremie25thesis} (PhD, bourse AgileNeuRobot (ANR-20-CE23-0021), 10/2021-09/2025, soutenue en octobre 2025),
...
\begin{itemize}
	\item ``Opening the Black Box: An Exactly Solvable Neural Network That Remembers, Predicts, and Remains Mathematically Tractable'' par Shikder, Anif Naiyer sous la direction de Lyle Muller et Jan Minac, soutenue en 2026 (Rapporteur),

	\item ``Amélioration de l'apprentissage dans les réseaux de neurones impulsionnels'' par Ilyass Hammouamri sous la direction de Timothée Masquelier au CERCO --- Centre de Recherche Cerveau et Cognition (Toulouse), soutenue en octobre 2025 (Rapporteur),

	\item ``Apprentissage supervisé efficace pour les réseaux de neurones impulsionnels à codage temporel'' par Gaspard Goupy sous la direction de Ioan Marius Bilasco et Pierre Tirilly dans l'équipe FOX du laboratoire CRIStAL (Lille), soutenue en octobre 2025 (Rapporteur),

	\item ``Avancées en vision neuromorphique~: représentation événementielle, réseaux de neurones impulsionnels supervisés et pré-entraînement auto-supervisé'' par Sami Barchid sous la direction de Chaabane Djeraba --- Informatique et applications --- Université de Lille, soutenue en 2023 (Rapporteur),

	\item ``Méthodes d'apprentissage profond inspirées par la physique pour l'inférence de la qualité de l'air'' par Matthieu Dabrowski sous la direction de Chaabane Djeraba, Jérôme Riedi et José Mennesson --- Informatique et applications --- Université de Lille, soutenue en 2024 (Rapporteur),
...
\begin{itemize}
	\item Sensibilisation étudiants : \og{}NeuroTalk sur le thème des métiers du cerveau\fg{} (\href{https://laurentperrinet.github.io/post/2025-11-24_neurotalk/}{lien vers l'événement}). \years{2025}
	...
	\item \og{}Le mystère de la Joconde éclairé par les neurosciences\fg{}, \textit{Cerveau et Psycho} (\href{https://laurentperrinet.github.io/post/2024-08-25-joconde/}{lien vers l'article}). \years{2024}

	\item \og{}Chats, mouches, humains : comment la vision a évolué en de multiples facettes\fg{}, \textit{The Conversation} (\href{https://laurentperrinet.github.io/publication/perrinet-24-yeux/}{lien vers l'article}). \years{2024}
	...
	\item Article de dissemination sur le \href{https://laurentperrinet.github.io/publication/perrinet-21-hasard/}{hasard} dans ``The conversation'' ($6200$ lectures au 16 Février 2022). \years{2022}

	\item Participation à une présentation ``stand up'' des NeuroStories~: conférence invitée  ``\href{https://laurentperrinet.github.io/post/2019-10-07_neurostories/}{Le temps des sens}''. \years{2019}
	...
	\item Article de dissemination sur les \href{https://theconversation.com/illusions-et-hallucinations-visuelles-une-porte-sur-la-perception-117389}{illusions visuelles} dans ``The conversation'' ($12500$ lectures au 16 Février 2022). \years{2018}
	...
	\item Participation à des activités grand public: conférence invitée\years{2016} ``Les illusions visuelles, un révélateur du fonctionnement de notre cerveau" \url{2016-04-25_PollyMaggoo}. \years{2016}
...
J'ai pris part à une école d'été organisée en janvier 2019 par le centre de neurosciences computationnelles de Valparaiso au Chili. Les thèmes abordés au cours de cette école étaient:
\begin{itemize}
...
\begin{itemize}
    ...
    \item Responsabilités ou activités collectives au CNRS~: De Janvier 2022 à Juin 2025, j'ai été nommé à la commission interdisciplinaire \og Modélisation mathématique, informatique et physique pour les sciences du vivant \fg{} (CID51) lors du dernier mandat.
