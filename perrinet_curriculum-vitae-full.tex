...
\newcommand{\Bio}{ 
Laurent Perrinet est un chercheur en neuroscience spécialisé dans l’exploration de modèle théoriques des mécanismes de la perception visuelle. Il est directeur de recherche CNRS à l’institut des neurosciences de la Timone à Marseile. L’axe de recherche vise à comprendre comment les différents fragments de l’information visuelle sont unifiés dans une perception cohérente, et ceci malgré les incertitudes intrinsèques à la structure de l’information visuelle. Cette recherche vise à construire des algorithmes inspirés  de la biologie qui permettent des gains en performance mais aussi de réduire leur consommation }
%%%%%%%%%%%%%%%%%%
%BIBLIOGRAPHY
%%%%%%%%%%%%%%%%%%
...
--- brèves impulsions se propageant de neurone en neurone --- constituent en
effet une caractéristique universelle des systèmes nerveux et offrent un
substrat naturel pour modéliser le traitement dynamique de l'information.
Sur le plan fonctionnel, j'intègre dans ces modèles des stratégies
d'inférence reposant sur des mécanismes d'apprentissage auto-organisés, qui
ancrent les relations spatio-temporelles entre neurones. Sur le plan
applicatif, ces travaux ouvrent la voie à de nouveaux algorithmes
neuromorphiques à haute efficacité énergétique.

\subsection*{Résumé des travaux antérieurs et de leur impact scientifique}


Mes travaux de thèse dirigés par Simon Thorpe et Manuel Samuelides ont permis
d'explorer dans un cadre mathématique de nouveaux paradigmes de codage neural
impulsionnel pour des images statiques~\citep{Perrinet03ieee}, et en
particulier comment ceux-ci peuvent être appris par des règles hebbienne
parcimonieuses~\citep{Perrinet10shl}. Ces travaux ont été étendus en
collaboration avec Guillaume Masson à des modèles d'inférence statistique
appliqués aux mouvements des yeux et à la boucle perception--action~\citep{Simoncini12}.
Un cadre théorique précis a ensuite été développé en collaboration avec Karl
Friston pour intégrer les délais temporels dans les modèles
prédictifs~\citep{PerrinetAdamsFriston14}.

Plus récemment, j'ai étendu ces modèles au traitement
dynamique de scènes visuelles en mouvement~\citep{KhoeiMassonPerrinet17},
puis à des architectures hiérarchiques bio-inspirées~\citep{BoutinFranciosiniChavaneRuffierPerrinet20,Franciosini21}.
Ces travaux ont notamment permis de revisiter la structure de la connectivité
horizontale dans le cortex visuel primaire~\citep{Chavane22}. Nous avons par
ailleurs mis en évidence le rôle de la précision sensorielle dans le
traitement de l'information corticale~\citep{Ladret23}, ouvrant la voie à une
représentation parcimonieuse plus efficace des images
naturelles~\citep{Ladret24sparse}.

Ces avancées nous ont permis de concevoir de nouveaux algorithmes
neuromorphiques de type réseaux de neurones impulsionnels (SNN), capables
d'une reconnaissance robuste et ultra-rapide fondée sur la détection de motifs
spatio-temporels de spikes~\citep{Grimaldi24}. En parallèle, l'intégration
d'une rétinotopie fovéale dans des architectures de vision bio-inspirées
améliore significativement la localisation et la catégorisation d'objets dans
des conditions écologiques~\citep{Jeremie25}, y compris pour des tâches de
recherche visuelle active~\citep{Jeremie25thesis}. Enfin, des collaborations
récentes ont étendu le cadre du codage prédictif à la prévision de séries
temporelles~\citep{Gunasekaran25} et à la modélisation de textures dynamiques
naturelles~\citep{Meso25}, illustrant la portée transversale de ces
approches.
...
\begin{itemize}
	...
	\item $5$ finalisées en encadrement principal~\citep{Khoei14thesis,Boutin20thesis,Franciosini21thesis,Ladret24thesis,Grimaldi24thesis,Jeremie25thesis},
	\item $4$ co-dirigées finalisées~\citep{Kremkow09thesis,Damasse18thesis,MansourPour19thesis,Gruel23thesis},
	\item Rapporteur de $18$ thèses, Président du jury de jury pour $4$ thèses, Examinateur pour $13$ thèses.
\end{itemize} %
\item $5$ Post-docs dirigés (Wahiba Taouali, Nicole Voges, Alberto Vergani, Adrien Fois, Thomas Kronland-Martinet),
\item $1$ contrat ANR en PI local ($150~k$\euro{}, contrat total $435~k$\euro{}), 1 AAP ($100~k$\euro{}), $3$ bourses de thèse obtenues,
...
\begin{itemize}
	...
	\item \href{https://laurentperrinet.github.io/author/alexandre-lain%C3%A9/}{Matthis Dallain} ``Focus of attention: a sensory-motor task for energy reduction in spiking neural networks.'' (PhD, 10/2024-09/2027, en co-direction avec Ben,oît Miramond et Laurent Rodriguez, LEAT)
	...
	\item \href{https://laurentperrinet.github.io/author/agathe-choplin/}{Agathe Choplin} ``Characterization of Physiological States using Machine Learning'' (PhD, 10/2024-09/2027)
	\item \href{https://laurentperrinet.github.io/author/charlotte-roy/}{Charlotte Roy} ``Impact de l'incarnation dans un avatar sur le bien-être et la prise de décision dans le Métaverse'' (PhD, 10/2024-09/2027, en co-supervision avec Olivia Petit, KEDGE)
\end{itemize}
...
\begin{itemize}
	...
	\item \href{https://laurentperrinet.github.io/author/adrien-fois/}{Adrien Fois} ``Accurate detection of precise spiking motifs in neurobiological data'' (Post-doc, bourse Polychronies grant (AMX-21-RID-025), 10/2023-02/2025)
...
\begin{itemize}
    ...
    \item ``Amélioration de l'apprentissage dans les réseaux de neurones
impulsionnels'' par Ilyass Hammouamri sous la direction de Timothée Masquelier au CERCO - Centre de Recherche Cerveau et Cognition (Toulouse), soutenue en Octobre 2025,
...
\begin{itemize}
    ...
    \item Sensibilisation étudiants : \og NeuroTalk sur le thème des métiers du cerveau \fg{} (\href{hhttps://laurentperrinet.github.io/post/2025-11-24_neurotalk/}{lien vers l'événement}).
...
\begin{itemize}
   ...
   \item 2023-04-03, 2024-05-13, 2025-05-26 : Master M4NC de l’institut NeuroMod, cours \og Prospective Innovation and Research \fg{} à \href{https://neuromod.univ-cotedazur.eu/}{\textit{Neuromod}} : \textit{Artificial neural networks and machine learning applied to the understanding of biological vision} (\href{https://laurentperrinet.github.io/talk/artificial-neural-networks-and-machine-learning-applied-to-the-understanding-of-biological-vision/}{lien vers le cours}). \years{2023-2025}

    \item 2023-03-29, 2024-04-10, 2026-03-05 : Master 1 Neurosciences et Sciences Cognitives (\href{https://laurentperrinet.github.io/talk/2023-04-05-ue-neurosciences-computationnelles/}{lien vers le cours}). \years{2023-2025}

    \item 2023-05-10, 2024-04-17, 2025-03-11 : Programme doctoral \textit{NeuroSchool PhD Program in Neuroscience} (\href{https://laurentperrinet.github.io/talk/2024-04-17-phd-program-sparse-representations/}{lien vers le cours}). \years{2023-2025}
\end{itemize}
