...
%\begin{resume}
\indent 49 ans, né le 23 Février 1973 à Talence (Gironde, France).  %\\
...
\begin{itemize}
	\item  $3$ finalisées (Angelo Franciosini, Victor Boutin, Mina Khoei),
	\item  $3$ en cours (Hugo Ladret, Jean-Nicolas Jérémie, Antoine Grimaldi) 
	\item $4$ co-dirigées (Amélie Gruel, Kiana Mansour Pour, JB Damasse, Jens Kremkow),
