...
\item[B1] \fullcite{Perrinet03these}
 ...
 \item[T8] \fullcite{Grimaldi2024thesis}
 
 \item[T7] \fullcite{Ladret2024thesis}
 
 \item[T6] \fullcite{Gruel2023thesis} (co-encadrement avec Jean Martinet)
 
 \item[T5] \fullcite{Franciosini2021thesis}

 \item[T4] \fullcite{MansourPour2019thesis} (co-encadrement avec Anna Montagnini)
 
 \item[T3] \fullcite{Damasse2018thesis} (co-encadrement avec Anna Montagnini)

 \item[T2] \fullcite{Khoei2014thesis}
 
 \item[T1] \fullcite{Kremkow2009thesis} (co-encadrement avec Guillaume Masson)
  \end{enumerate}
