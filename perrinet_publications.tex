...
\item[B1] \fullcite{Perrinet03these}
 ...
 \item[T6] \fullcite{Gruel23thesis} (co-encadrement avec Jean Martinet)
 
 \item[T5] \fullcite{Franciosini21thesis}

 \item[T4] \fullcite{MansourPour19thesis} (co-encadrement avec Anna Montagnini)
 
 \item[T3] \fullcite{Damasse18thesis} (co-encadrement avec Anna Montagnini)

 \item[T2] \fullcite{Khoei14thesis}
 
 \item[T1] \fullcite{Kremkow09thesis} (co-encadrement avec Guillaume Masson)
  \end{enumerate}
