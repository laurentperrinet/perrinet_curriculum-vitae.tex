...
\addbibresource{~/quantic/blog/perrinet_curriculum-vitae_tex/LaurentPerrinet_Presentations.bib}
...
\graphicspath{{./Perrinet19PredictiveProcessing/figures/}}%
...
\item[A46] \fullcite{BoutinFranciosiniRuffierPerrinet19feedback}% _LA_

\item[A45] \fullcite{BoutinFranciosiniChavaneRuffierPerrinet19}% _LA_

\item[A44] \fullcite{Dauce19} %  _LA_

\item[A43] \fullcite{PasturelMontagniniPerrinet19}%  _LA_
...
\item[A6] \years{2002}~\fullcite{Perrinet02sparse}% _FA_


\item[A5] \fullcite{Perrinet03ieee}% _FA_

\item[A4] \years{2003}~\fullcite{Perrinet03}% _FA_
...
\begin{enumerate}
%
\item[B6] \fullcite{Perrinet19}% _FA_
...
\item \fullcite{LadretPerrinet18gdr}
