...
% -*- coding: UTF-8; -*-
% vim: set fenc=utf-8
\documentclass[french,a4paper,oneside]{article}%,twoside,draft
%============ common ===================
...
\newcommand{\SubTitle}{%
%Pour évaluation par les sections du Comité national22U
}%
...
\begin{enumerate}
% \item[A59] \fullcite{}% _FA_
\item[A65] 
\fullcite{Benvenuti22}%

\item[A64] 
  \fullcite{Perrinet26}% _LA_

\item[A63] 
  \fullcite{Dallain26}% _LA_
...
\years{2026} 
  ...
  \item[A62] 
  \fullcite{Mairot26}% _LA_

  \item[A61] 
  \fullcite{Kronlandmartinet26}% _LA_

\item[A60] 
\fullcite{Jeremie25}% _LA_
...
\item[A58] 
  \fullcite{Gunasekaran25}% 
  
\item[A57] 
  \years{2024} 
  \fullcite{Grimaldi24}% _LA_
  
\item[A56] 
  \fullcite{Ladret24sparse}% _LA_

\item[A55] 
\years{2023} 
  \fullcite{Rentzeperis23}
  
\item[A54] 
  \fullcite{Gruel23BC}% _LA_
  
\item[A53] 
  \fullcite{Grimaldi23BC}% _LA_
  
\item[A52] 
  \fullcite{Ladret23}% _LA_

\item[A51] 
  \fullcite{Jeremie23UltraFastCat}% _LA_
  
\item[A50] 
\years{2022} 
  \fullcite{Grimaldi22polychronies}% _LA_

\item[A49] \fullcite{Franciosini21}% _LA_

\item[A48] \fullcite{Barthelemy22}% _LA_

\item[A47] \fullcite{Chavane22}%

\item[A46] \years{2021} \fullcite{BoutinFranciosiniChavaneRuffierPerrinet20}% _LA_
...
\begin{enumerate}
%
\item[C6] \fullcite{Perrinet20}% _FA_

\item[C5] \fullcite{Montagnini15bicv}

\item[C4] \fullcite{Perrinet15bicv}% _FA_

\item[C3] \fullcite{CristobalPerrinetKeil15bicv_chap1}

\item[C2] \fullcite{Cessac07a}

\item[C1] \fullcite{Perrinet07}% _FA_
%Laurent~U. Perrinet.
...
\section{Thèses, projets et ouvrages}%

\begin{enumerate}

\item[B6] \fullcite{Perrinet20dr}

\item[B5] \fullcite{CristobalPerrinetKeil15bicv}

\item[B4] \fullcite{Perrinet14hdr}

\item[B3] \fullcite{Perrinet08neurocomp}

\item[B2] \fullcite{Cessac07}

\item[B1] \fullcite{Perrinet03these}
 \end{enumerate}
 
 \section{Thèses de doctorat encadrées}%
 
 
 \begin{enumerate}
 
 \item[T9] \fullcite{Jeremie25thesis}
 
 \item[T8] \fullcite{Grimaldi24thesis}
 
 \item[T7] \fullcite{Ladret24thesis}
 
 \item[T6] \fullcite{Gruel23thesis}
 
 \item[T5] \fullcite{Franciosini21thesis}

 \item[T4] \fullcite{MansourPour19thesis}
 
 \item[T3] \fullcite{Damasse18thesis}

 \item[T2] \fullcite{Khoei14thesis}
 
 \item[T1] \fullcite{Kremkow09thesis}
  \end{enumerate}
 
 
\section{Actes de conférences internationales à comité de lecture}%
%~\citep{Perrinet08spie}
\begin{etaremune} % enumerate à l'envers

  % # 2026
  \item \fullcite{Perrinet26ICANN}% _FA_ _LA_
  \item \fullcite{Grimaldi26FENS}% 
  \item \fullcite{Laine26AREADNE}% 
  \item \fullcite{Perrinet26airov}% _FA_ _LA_
  \item \fullcite{Choplin26BCI}% 

% # 2025
\item \fullcite{Kronlandmartinet25snufa}% 
\item \fullcite{Laine25cns}% 
\item \fullcite{Choplin25CCN}% 
\item \fullcite{Jeremie25CCN}% 
\item \fullcite{Grimaldi25cosyne}% 
  
% # 2024
\item \fullcite{Gekas24ecvp}% 
\item \fullcite{Jeremie24CCN}% _LA_
\item \fullcite{Cortes24FENS}% _LA_
\item \fullcite{Jeremie24FENS}% _LA_
\item \fullcite{Fois24FENS}% _LA_
\item \fullcite{Perrinet24FENS}% _FA_ _LA_
 
% # 2023
\item \fullcite{Perrinet23ICANN}% _FA_ _LA_
\item \fullcite{Jeremie23ICANN}% _FA_ _LA_
\item \fullcite{Nunes23ICCV}% 
\item \fullcite{Jeremie23CCN}% _LA_
\item \fullcite{Ladret23ICLR}
\item \fullcite{Grimaldi23GDR}
\item \fullcite{Ladret23cosyne}

% # 2022
% \item \fullcite{Ladret21sfn}
\item \fullcite{Grimaldi22ICIP}% _LA_
\item \fullcite{Grimaldi22FENS}% _LA_
\item \fullcite{Ladret22FENS}% _LA_
\item \fullcite{Jeremie22FENS}% _LA_
\item \fullcite{Dabane22}% 
\item \fullcite{Ladret22AREADNE}% _LA_
\item \fullcite{Rentzeperis22AREADNE}% _LA_
\item \fullcite{Jeremie22AREADNE}% _LA_
\item \fullcite{Grimaldi22AREADNE}% _LA_
...
\item \fullcite{Perrinet19nccd} % _FA_
...
\section{Séminaires ou Conférences avec présentations orales ou affichées}% 

\begin{etaremune}%enumerate}
  \item \fullcite{2026-09-18-int}
  \item \fullcite{2026-04-16-cerco}
  \item \fullcite{2026-02-10-biomplus}
  \item \fullcite{2026-02-03-ai-and-neuroscience-day}
  \item \fullcite{2026-01-29-emergences}
  \item \fullcite{2025-12-12_main}
  \item \fullcite{2025-12-02_symposium-masters}
  \item \fullcite{2025-10-16-flash-lag-effect}
  \item \fullcite{2025-04-18-vibration-apparences}
  \item \fullcite{2025-02-14-supaero}
  \item \fullcite{2025-02-11-neuromath}
  \item \fullcite{2025-01-08-brain-seminar}
  \item \fullcite{2024-11-18-biomim}
  \item \fullcite{2024-09-09-agileneurobot-anr}
  \item \fullcite{2024-03-27-emergences}
  \item \fullcite{2024-02-05-udem}
  \item \fullcite{2023-12-01-biocomp}
  \item \fullcite{2023-12-14-jraf} 
  \item \fullcite{2023-11-07_SNUFA} 
  \item \fullcite{2023-09-27_ICANN} 
  \item \fullcite{2023-09-08_fresnel}
  \item \fullcite{2023-01-23_game-theory-and-the-brain}
  \item \fullcite{2022-06-19_NeuroVision-heterogeneous}
  \item \fullcite{2022-06-19_NeuroVision-retinotopic}
  \item \fullcite{2022-06-14_MIR-symposium}
  \item \fullcite{2022-05-19_CENTURI-day}
...
\begin{etaremune}%enumerate}
  \item \fullcite{2026-04-11-intelligence-du-regard}
  \item \fullcite{2026-03-24_phd-program-spiking-neural-nets}
  \item \fullcite{2026-03-05_ue-natural-cognition}
  \item \fullcite{2026-01-19_art-and-science}
  \item \fullcite{2025-06-12_explore-conference-immersive}
  \item \fullcite{2025-06-10_explore-cine-sciences}
  \item \fullcite{2025-05-26_master-M4NC}
  \item \fullcite{2025-03-11_phd-program-sparse-representations}
  \item \fullcite{Ladret24joconde}
  \item \fullcite{Perrinet24yeux}
  \item \fullcite{Perrinet23formes-et-perception}
  \item \fullcite{2024-05-13_master-M4NC}
  \item \fullcite{2024-04-17_phd-program-sparse-representations}
  \item \fullcite{2024-04-10_UE-neurosciences-computationnelles}
  \item \fullcite{2023-05-10_phd-program_neurosciences-computationnelles}
  \item \fullcite{2023-04-05_UE-neurosciences-computationnelles}
  \item \fullcite{2023-04-03_master-M4NC}
  \item \fullcite{2022-03-23_UE-neurosciences-computationnelles}
