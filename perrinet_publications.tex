...
\item[A58] \fullcite{Rentzeperis23}

\item[A57] \fullcite{Benvenuti22}% _LA_

\item[A56] \fullcite{Gruel22BC}% _LA_

\item[A55] \fullcite{Jeremie22BC}% _LA_

\item[A54] \fullcite{Grimaldi22BC}% _LA_
  
\item[A53] \fullcite{Ladret23}% _LA_

\item[A52] 
\fullcite{Grimaldi22pami}% _LA_
